...
describe("decode", () => {
    ...
    describe("decodeByteSlice", () => {
        ...
        it("decodes 4 byte slice", () => {
            const [value, length] = Amino.decodeByteSlice(
    ...
    describe("decodeInt32", () => {
        ...
        it("decodes `2147483647`", () => {
            const [value, length] = Amino.decodeInt32(
    ...
    describe("decodeInt64", () => {
        it("decodes `0`", () => {
            const [value, length] = Amino.decodeInt64(
        ...
        it("decodes `Number.MIN_SAFE_INTEGER`", () => {
            const [value, length] = Amino.decodeInt64(
                new Uint8Array([1, 0, 0, 0, 0, 0, 224, 255])
            );
            expect(length).toBe(8);
    ...
    describe("decodeVarint", () => {
        ...
        it("decodes `Number.MAX_SAFE_INTEGER`", () => {
            const [value, length] = Amino.decodeVarint(
                new Uint8Array([254, 255, 255, 255, 255, 255, 255, 31])
            );
            expect(length).toBe(8);
            expect(value).toBe(Number.MAX_SAFE_INTEGER);
        });
        ...
        it("decodes `Number.MIN_SAFE_INTEGER`", () => {
            const [value, length] = Amino.decodeVarint(
                new Uint8Array([253, 255, 255, 255, 255, 255, 255, 31])
            );
            expect(length).toBe(8);
            expect(value).toBe(Number.MIN_SAFE_INTEGER);
        });
        ...
        it.skip("decodes `9223372036854775807`", () => {
            const [value, length] = Amino.decodeVarint(
                new Uint8Array([254, 255, 255, 255, 255, 255, 255, 255, 255, 1])
            );
    ...
    describe("decodeUint32", () => {
        ...
        it("decodes `4294967295`", () => {
            const [value, length] = Amino.decodeUint32(
    ...
    describe("decodeUint64", () => {
        it("decodes `0`", () => {
            const [value, length] = Amino.decodeUint64(
                new Uint8Array([0, 0, 0, 0, 0, 0, 0, 0])
            );
            expect(length).toBe(8);
            expect(value).toBe(0);
    ...
    describe("decodeUvarint", () => {
        ...
        it("decodes `Number.MAX_SAFE_INTEGER`", () => {
            const [value, length] = Amino.decodeUvarint(
    ...
    describe("decodeFloat32", () => {
        ...
        it("decodes `3.40282346638528859811704183484516925440e+38`", () => {
            const [value, length] = Amino.decodeFloat32(
                new Uint8Array([255, 255, 127, 127])
            );
            expect(length).toBe(4);
            expect(value).toBe(3.4028234663852885981170418348451692544e38);
        });
        ...
        it("decodes `1.401298464324817070923729583289916131280e-45`", () => {
            ...
            expect(length).toBe(4);
            expect(value).toBe(1.40129846432481707092372958328991613128e-45);
        });
    });

    describe("decodeFloat64", () => {
        it("decodes `0`", () => {
            const [value, length] = Amino.decodeFloat64(
                new Uint8Array([0, 0, 0, 0, 0, 0, 0, 0])
            );
            expect(length).toBe(8);
            expect(value).toBe(0);
        ...
        it("decodes `1.797693134862315708145274237317043567981e+308`", () => {
            ...
            expect(length).toBe(8);
            expect(value).toBe(1.797693134862315708145274237317043567981e308);
        });
    ...
    describe("decodeString", () => {
        it('encodes `"hello"`', () => {
            const [value, length] = Amino.decodeString(
    ...
    describe("decodeTime", () => {
        ...
        it('decodes `new Date("2000-01-01T00:00:00Z")`', () => {
            const [value, length] = Amino.decodeTime(
                new Uint8Array([8, 128, 135, 181, 195, 3])
            );
            expect(length).toBe(6);
